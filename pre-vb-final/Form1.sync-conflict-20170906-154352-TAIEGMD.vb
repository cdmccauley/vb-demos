...
Public Class frmDateAdd
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        Catch ex As Exception
            If txtStartMonth.Text = "" Or txtStartDay.Text = "" Or txtStartYear.Text = "" Then
                'handles blank date
                MessageBox.Show("Please enter a complete start date. (MM/DD/YYYY HH)",
                                "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            ElseIf bytMonth < 1 Or bytMonth > 12 Then
                'ignore a second error message caused by passing invalid month value as an array index
            Else
                'handles all other invalid input
